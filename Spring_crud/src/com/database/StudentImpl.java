...
//	}
	public StudentImpl() {
		System.out.println("zero arg constructor for student-imp");
	}
	...
	@Override
	public Student findAllStudentbyRollNo(int roolNo) {
		String query = "select * from student where Roll_No=?";
		Student student = jdbc.queryForObject(query, new StudentRowMapper(), roolNo);
		return student;
	}
